...
%kod do odtworzenia wykresu 6 z badania 10118829, 
    ...
    for linkIdx = 1:numLinks
        ...
        % PHY/MAC settings must match the MLO BSS, otherwise wlanDeviceConfig
        % defaults (1x1, aggregation 64, 10 dBm, HE-SU) make the comparison unfair.
        apCfg(linkIdx) = wlanDeviceConfig(Mode="AP", MCS=mcs, ChannelBandwidth=channelBW, BandAndChannel=bandAndChannel(linkIdx, :), ...
            TransmissionFormat="EHT-SU", NumSpaceTimeStreams=2, NumTransmitAntennas=2, ...
            MPDUAggregationLimit=aggregationLimit, TransmitPower=transmissionPower);
