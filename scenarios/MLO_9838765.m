function [thr, latencyMainSTA, avgLatency ] = MLO_9838765(randnum, simTime, radius, radiusList, channelBW, isMLO, mcs, maxThr, expectedLoad, expectedOccupancies)
